...
def main(args):
    ...
    lr_scheduler = ReduceLROnPlateau(optimizer, patience = 200, verbose=True)
...
def parse_args():
    ...
    #parser.add_argument('-t', '--train-anno', default='tiny_data.txt', help='name of train anno')
    #parser.add_argument('-v', '--val-anno', default='tiny_data.txt', help='name of val anno')
    ...
    parser.add_argument('-wd', '--weight-decay', default=1e-5, type=float, help='weight decay (default: 1e-4)')
