...
class FWIDataset(Dataset):
    ...
    '''
    def __init__(self, anno, preload=True, sample_ratio=1, sources=2, file_size=1000,
    ...
    def load_every(self, batch):
        ...
        if self.trunc:
                data = np.load(data_path)[:, :, 140::self.sample_ratio, :]
        else:
